...
const faqs = [
  ...
  },
  {
    ...
    answer:
      "HeaderGuard analyzes cookie security (Secure, HttpOnly, SameSite flags), detects information disclosure headers (Server, X-Powered-By), gives you a numeric score out of 100, and provides copy-paste fix code for every issue found. SecurityHeaders.com gives a letter grade and links to external docs.",
  },
  {
